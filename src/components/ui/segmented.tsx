        ...
        return (
          <button
            ...
            className={cn(
              ...
              isActive
                // Active = gradient-end accent wash — matches Sidebar + FilterBar active treatment across the app
                ? 'bg-[color-mix(in_srgb,var(--color-grad-to)_24%,transparent)] text-text shadow-xs'
